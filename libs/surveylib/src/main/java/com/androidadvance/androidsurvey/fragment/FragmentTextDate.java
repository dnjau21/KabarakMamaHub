...
public class FragmentTextDate extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        datePickerFragment.date = editText_answer;
        /*Bundle bundle = new Bundle();
        bundle.putInt("viewId", R.id.editText_answer);
